...
from transformers.models.opt import OPTForCausalLM, OPTForSequenceClassification, OPTModel, OPTPreTrainedModel  
...
class DistributedOPTModel(FromPretrainedMixin, PTuneMixin, OPTModel):  
...
class DistributedOPTForCausalLM(FromPretrainedMixin, RemoteGenerationMixin, OPTForCausalLM):  
    _keys_to_ignore_on_load_missing = DistributedOPTModel._keys_to_ignore_on_load_missing  
    _keys_to_ignore_on_load_unexpected = DistributedOPTModel._keys_to_ignore_on_load_unexpected  
